...
$msgs = @(
"No deberias dejar el ordenador solo, luego pasan estas cosas"
"Solo podras recuperar la informacion si envias 5 BTC a esta direccion"
"Hemos encontrado pornografia infantil en tu ordenador, contactando con la policia..."
"Eliminando archivos viatles...."
"Formateando Ordenador..."
"Archivos necesarios para el correcto funcionamiento de Windows eliminados"
"Borrando todas las imagenes del ordenador..."
"Publicando datos y credenciales en Google"
)
